package net.whgkswo.tesm.world.biome.surface;

import net.minecraft.block.Block;
import net.minecraft.block.Blocks;
import net.minecraft.world.gen.surfacebuilder.MaterialRules;
import net.whgkswo.tesm.world.biome.ModBiomes;
...
public class ModMaterialRules {
    ...
    public static MaterialRules.MaterialRule makeRules() {
        ...
        MaterialRules.MaterialRule grassSurface = MaterialRules.sequence(MaterialRules.condition(isAtOrAboveWaterLevel, GRASS_BLOCK), GRASS_BLOCK);
