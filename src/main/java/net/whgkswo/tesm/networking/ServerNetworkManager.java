...
import net.whgkswo.tesm.networking.payload.data.c2s_req.*;
...
public class ServerNetworkManager {
    ...
    public static void registerC2SReceivers(){
        ...
        ServerPlayNetworking.registerGlobalReceiver(BlockDataReq.PACKET_ID, DoorDataC2SReceiver::handle);
    ...
    public static void registerC2SCodecs(){
        ...
        PayloadTypeRegistry.playC2S().register(BlockDataReq.PACKET_ID, BlockDataReq.PACKET_CODEC);
